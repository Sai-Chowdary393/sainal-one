...
export async function createTaskFromPrompt({
  ...
  //
  // Projects supplied by the AI route have already been
  // filtered using the current employee's RBAC permissions.
  // =======================================================
  ...
  //
  // SECURITY:
  // An AI-created task is assigned to the employee who
  // requested it.
  //
  // We deliberately do NOT automatically inherit the
  // Project owner because that would allow tasks.create
  // to behave like tasks.assign.
  // =======================================================
