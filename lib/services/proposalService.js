...
export async function createProposalFromPrompt({
  ...
  if (!organizationId) {
    throw new Error(
      "Organisation is required to create a proposal."
    );
  }

  if (!employeeId) {
    throw new Error(
      "Employee ownership is required to create a proposal."
    );
  }
  ...
  //
  // SECURITY:
  // AI-created Proposal belongs to the signed-in employee.
  // =======================================================
