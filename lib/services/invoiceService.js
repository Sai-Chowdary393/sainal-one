...
export async function convertQuoteToInvoice({
  ...
  //
  // SECURITY:
  // AI-created Invoice belongs to the employee performing
  // the conversion. We do not silently inherit Quote owner.
  // =======================================================
  ...
  if (
    ...
    /*
     * Avoid leaving a newly-created Invoice behind when
     * the associated Quote could not be updated.
     */
    const {
      error:
        cleanupError,
