...
export function getRecordPermissions(
   ...
   * Compatibility rule:
   *
   * Older/general permissions such as:
   *
   *   quotes.view
   *   leads.view
   *   customers.view
   *
   * do not specify a record scope.
   *
   * For security, a generic "view" permission is treated
   * as OWN-record access only.
   *
   * It must never automatically become view_all.
   */
