    ...
    try {
      ...
      for (
        ...
        if (
          ...
          throw new Error(
            `${item.name} dashboard request failed.`
          );
        }
      }
          ...
          >
            ...
            >
              ...
              <KpiCard
                ...
                supporting={`${totalQuotes} visible quotes`}
                tone="blue"
                href="/quotes"
              />
              ...
              <KpiCard
                ...
                supporting={`${totalCustomers} visible customers`}
                tone="purple"
                href="/leads"
              />
            ...
            >
              ...
              <ChartPanel
                ...
                description="Visible quotes grouped by their current status"
                actionHref="/quotes"
            ...
            >
              ...
              <ChartPanel
                ...
                description="Current visible project and task completion"
                actionHref="/projects"
            ...
            >
              ...
              >
                ...
                >
                  {latestLeads.length ===
                  0 ? (
                    <EmptyState message="No visible leads." />
                  ) : (
                    latestLeads.map(
                      (
                        lead
                ...
                >
                  {latestQuotes.length ===
                  0 ? (
                    <EmptyState message="No visible quotes." />
                  ) : (
                    latestQuotes.map(
                      (
                        quote
                        ...
                        <ActivityRow
                          ...
                          description={`${quote.client || "No client"} · ${formatCurrency(
                            getMoneyValue(
                              quote.amount
                            )
                          )}`}
                ...
                >
                  ...
                  0 ? (
                    <EmptyState message="No visible active projects." />
                  ) : (
                    latestProjects.map(
                      (
                        project
                ...
                >
                  {latestTasks.length ===
                  0 ? (
                    <EmptyState message="No visible tasks." />
                  ) : (
                    latestTasks.map(
                      (
                        task
                ...
                <ActivityPanel
                  ...
                  href="/invoices"
                  className={
                    styles.wideActivityPanel
                  }
                >
                  {latestInvoices.length ===
                  0 ? (
                    <EmptyState message="No visible invoices." />
                  ) : (
                    latestInvoices.map(
                      (
                        invoice
                        ...
                        <ActivityRow
                          ...
                          description={`${invoice.client || "No client"} · ${formatCurrency(
                            getMoneyValue(
                              invoice.total_amount ||
                                invoice.amount
                            )
